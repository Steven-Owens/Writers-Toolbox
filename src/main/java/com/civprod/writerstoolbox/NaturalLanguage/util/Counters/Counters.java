...
public class Counters {
  ...
  public static <E> String toBiggestValuesFirstString(Counter<E> c, int k) {
    NaturalLanguagePriorityQueue<E> pq = c.asPriorityQueue();
    NaturalLanguagePriorityQueue<E> largestK = new NaturalLanguagePriorityQueue<E>();
  ...
  public static <E> List<E> sortedKeys(Counter<E> counter) {
    ...
    NaturalLanguagePriorityQueue<E> pq = counter.asPriorityQueue();
    while (pq.hasNext()) {
