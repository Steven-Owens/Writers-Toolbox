 ...
 * @author Dan Klein
 */
public class NaturalLanguagePriorityQueue <E> implements Iterator<E>, Serializable, Cloneable {
  int size;
  int capacity;
  List<E> elements;
  double[] priorities;
  ...
  public String toString(int maxKeysToPrint) {
    NaturalLanguagePriorityQueue<E> pq = clone();
   ...
   */
  public NaturalLanguagePriorityQueue<E> clone() {
    NaturalLanguagePriorityQueue<E> clonePQ = new NaturalLanguagePriorityQueue<E>();
    clonePQ.size = size;
  ...
  public NaturalLanguagePriorityQueue() {
    this(15);
  }

  public NaturalLanguagePriorityQueue(int capacity) {
    int legalCapacity = 0;
  ...
  public static void main(String[] args) {
    NaturalLanguagePriorityQueue<String> pq = new NaturalLanguagePriorityQueue<String>();
