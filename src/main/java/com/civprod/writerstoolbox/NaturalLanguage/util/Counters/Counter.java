...
import com.civprod.writerstoolbox.NaturalLanguage.util.MapFactory;
import com.civprod.writerstoolbox.NaturalLanguage.util.NaturalLanguagePriorityQueue;
...
public class Counter <E> implements Serializable {
    ...
    public static <E> Counter<E> join(Counter<E>... inCounters){
        return join(java.util.Arrays.asList(inCounters));
    }
    public static <E> Counter<E> join(List<Counter<E>> inCounters){
        Counter<E> returnCounter = new Counter<>();
        for (Counter<E> curCounter : inCounters){
            returnCounter.incrementAll(curCounter);
        }
   ...
   */
  public NaturalLanguagePriorityQueue<E> asPriorityQueue() {
    NaturalLanguagePriorityQueue<E> pq = new NaturalLanguagePriorityQueue<E>(entries.size());
    for (Map.Entry<E, Double> entry : entries.entrySet()) {
